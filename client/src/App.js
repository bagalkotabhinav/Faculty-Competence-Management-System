...
import FilterPaper from './Components/Courses/Paper/FilterPaper';
import FilterPatent from './Components/Courses/Patent/FilterPatent';
    ...
    <div id="root">
      ...
      <main>
        <Routes>
          ...
          <Route path="/papers/filter" element={<PrivateRoute />}>
            <Route path="/papers/filter" element={<FilterPaper />} />
          </Route>
          <Route path="/patents/filter" element={<PrivateRoute />}>
            <Route path="/patents/filter" element={<FilterPatent />} />
          </Route>
